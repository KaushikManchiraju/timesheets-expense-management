...
public class CommandLineFrameController extends ScreenFragment {
    ...
    protected ResultExpensesHandler expensesHandler;
    ...
    public interface ResultExpensesHandler {
        void handle(List<Expenses> resultExpenses);
    }

    public ResultExpensesHandler getExpensesHandler() {
        return expensesHandler;
    }

    public void setExpensesHandler(ResultExpensesHandler expensesHandler) {
        this.expensesHandler = expensesHandler;
    }
